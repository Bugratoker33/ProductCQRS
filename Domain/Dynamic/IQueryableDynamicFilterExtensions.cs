...
namespace Domain.Dynamic;

public static class IQueryableDynamicFilterExtensions
{
    private static readonly string[] _orders = { "asc", "desc" };//sıralama işlemleri 
    private static readonly string[] _logics = { "and", "or" };//And ve Or yapıları 
...
{ "doesnotcontain", "Contains" }
    ...
    {//sorguyu linq sorgusuna çecirecek
